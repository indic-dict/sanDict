...
import sanskritcode.sanDict.frags.ListDictFragment
import sanskritcode.sanDict.frags.NavigatorFragment
import sanskritcode.sanDict.frags.RecentFragment
import sanskritcode.sanDict.frags.SearchFragment
import sanskritcode.sanDict.service.QDictService
import sanskritcode.sanDict.standout.StandOutWindow
...
class MainActivity : BaseActivity(), NavigatorFragment.NavigationCallbacks, OnClickListener {
    ...
    companion object {
        ...
        const val ACTION_UPDATE_UI = "sanskritcode.sanDict.ACTION_UPDATE_UI"
